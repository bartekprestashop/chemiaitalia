	...
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					...
					{/if}
					<div class="col-lg-6">
					<input type="text" class="subtitle" id="subtitle_{$language.id_lang|intval}" name="subtitle_{$language.id_lang|intval}" value="{if $menu->subtitle}{$menu->subtitle[$language.id_lang|intval]}{/if}"/>
					</div>
					{if $languages|count > 1}
						<div class="col-lg-2">
							<button type="button" class="btn btn-default dropdown-toggle" tabindex="-1" data-toggle="dropdown">
		...
		<div class="form-group lab-fw-icon">
			...
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='posvegamenu'} <a href="https://fontawesome.com/v5.15/icons?d=gallery&p=2&m=free">https://fontawesome.com/v5.15/icons?d=gallery&p=2&m=free</a> ex: <span class="o-40">&lt;i class="</span>fab fa-angellist<span class="o-40">"&gt;&lt;/i&gt;</span></p>   
			</div>
		</div>
