...
class Posslideshows extends Module implements WidgetInterface
{
	...
	protected $default_navigation = 0;
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            ...
            foreach ($languages as $language) {
                ...
                $imagesize = ($_FILES['image_'.$language['id_lang']]['tmp_name']) ?  @getimagesize($_FILES['image_'.$language['id_lang']]['tmp_name']) : false;
    ...
    public function hookdisplayHeader($params)
    {
		...
		Media::addJsDef(
            array(
                'POSSLIDESHOW_SPEED' => (int)$config['POSSLIDESHOW_SPEED'],
                'POSSLIDESHOW_NAV' => (int)$config['POSSLIDESHOW_NAV'],
                'POSSLIDESHOW_PAGI' => (int)$config['POSSLIDESHOW_PAGI']
             )
        );
    ...
    public function getAddFieldsValues()
    {
        ...
        $languages = Language::getLanguages(false);
		 ...
		 foreach ($languages as $lang) {
			...
			$fields['description'][$lang['id_lang']] = str_replace('/pos_greenfarm/',__PS_BASE_URI__,$fields['description'][$lang['id_lang']]);
		}
