	...
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group lab-fw-icon">
			...
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='posmegamenu'} <a href="https://fontawesome.com/v5.15/icons?d=gallery&p=2&m=free">https://fontawesome.com/v5.15/icons?d=gallery&p=2&m=free</a> ex: <span>&lt;i class="</span>fab fa-angellist<span>"&gt;&lt;/i&gt;</span></p> 
			</div>
		</div>
