...
class DpdShippingPickupCourierSettingsController extends FrameworkBundleAdminController
{
    ...
    {
        $quoteGridFactory = $this->get('dpdshipping.grid.factory.configuration.pickup.courier.settings.list');
        ...
        return $this->render('@Modules/dpdshipping/views/templates/admin/configuration/pickup-order-settings-list-form.html.twig', [
            'enableSidebar' => true,
            'layoutTitle' => $this->trans('Pickup order settings', 'Modules.Dpdshipping.Admin'),
    ...
    {
        $textFormDataHandler = $this->get('prestashop.module.dpdshipping.form.dpdshipping_pickup_courier_settings_form_data_handler');
    ...
    {
        $deleteSenderAddress = $this->get('prestashop.core.query_bus')->handle(new DeletePickupOrderSettingsAddressCommand($request->get('pickupCourierId')));
