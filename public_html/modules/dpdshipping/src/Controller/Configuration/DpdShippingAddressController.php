...
class DpdShippingAddressController extends FrameworkBundleAdminController
{
    ...
    {
        $quoteGridFactory = $this->get('dpdshipping.grid.factory.configuration.address');
    ...
    {
        $textFormDataHandler = $this->get('prestashop.module.dpdshipping.form.dpdshipping_address_form_data_handler');
    ...
    {
        $deleteSenderAddress = $this->get('prestashop.core.query_bus')->handle(new DeleteSenderAddressCommand($request->get('senderAddressId')));
