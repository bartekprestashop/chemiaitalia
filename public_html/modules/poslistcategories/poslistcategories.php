...
class PosListCategories extends Module implements WidgetInterface
{
	...
	public function getAddFieldsValues() 
	{
		...
		foreach ($languages as $lang)
		{
			...
			$fields['description'][$lang['id_lang']] = Tools::getValue('description_'.(int)$lang['id_lang'], (isset($slide->description[$lang['id_lang']])) ? $slide->description[$lang['id_lang']]: null);
    ...
    {	
		$req = 'SELECT hs.`list_subcategories`
				...
				WHERE hs.`id_poslistcategories_items` = '.(int)$id_item;
		$row = Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow($req);
		if (isset($row['list_subcategories'])) 
