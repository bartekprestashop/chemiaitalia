					...
					<div class="list-categories">
						<div class="box-inner">
							...
							<div class="desc-listcategoreis">		
								...
								<!-- <div class="see-more"><a href="{$link->getCategoryLink($category['id_category'])}" target="_blank">{l s='Shop Now' mod='poslistcategories'}<i class="ion ion-android-arrow-dropright"></i></a> </div> -->
							</div>	
						</div>							
					</div>	
