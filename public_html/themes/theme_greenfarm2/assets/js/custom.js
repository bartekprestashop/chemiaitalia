...
$(document).ready(function(){
	...
	$(function(){
	  $('.js-product-miniature').hover(function() {
		 $( this ).parents(".parents-product").find( ".shop-products" ).css('z-index','2');
	  }, function() {
		 $( this ).parents(".parents-product").find( ".shop-products" ).css('z-index','0');
	  });
	});
...
function display(view)
{
	if (view == 'grid')
	{
		...
		$('.product_content .item-product').removeClass('col-xs-12').addClass('col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-4');
