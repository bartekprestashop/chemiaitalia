	...
	<div class="blockcart cart-preview" data-refresh-url="{$refresh_url}" data-cartitems="{$cart.products_count}">
		<div class="header">
			<a rel="nofollow" href="{$cart_url}" class="desktop hidden-md-down">
				<span class="item_text">{l s='Shopping Cart' d='Shop.Theme.Actions'}</span>
				<span class="item_total">{$cart.products_count} {l s='items' d='Shop.Theme.Actions'} - {$cart.totals.total.value}</span>
			</a>
