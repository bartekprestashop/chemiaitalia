  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
    ...
    <div class="main-inner">
      ...
      <div class="col-md-7">
        ...
        {hook h='displayProductName' product=$product}
        ...
        <div class="product-information">
          {block name='product_description_short'}
            <div id="product-description-short-{$product.id}" class="product-desc" itemprop="description">
              {$product.description_short|truncate:400:' ...'|escape:'html':'UTF-8' nofilter}</div>
          {/block}
      ...
      <div class="col-xs-12">
        <div class="tabs">
          <ul class="nav nav-tabs">
            ...
            {/foreach}
{*            <li class="nav-item">*}
{*              <a class="nav-link" data-toggle="tab" href="#idTab5">{l s='Reviews' mod='productcomments'}</a>*}
{*            </li>*}
          </ul>
          ...
          <div class="tab-content" id="tab-content">
            ...
            {/block}
            {foreach from=$product.extraContent item=extra key=extraKey}
              <div class="tab-pane fade in {$extra.attr.class}" id="extra-{$extraKey}" {foreach $extra.attr as $key => $val}
                {$key}="{$val}" {/foreach}>
