...
class Posrecommendedproducts extends Module implements WidgetInterface
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue($this->prefixname . '_PRODUCTS', '1,2,3,4,5,6,7,8');
        ...
        Configuration::updateValue($this->prefixname . '_ITEMS_PER_MD', 1);
        Configuration::updateValue($this->prefixname . '_ITEMS_PER_SM', 1);
        Configuration::updateValue($this->prefixname . '_ITEMS_PER_XS', 1);
        Configuration::updateValue($this->prefixname . '_ITEMS_PER_XXS', 1);
        Configuration::updateValue($this->prefixname . '_ROW', 3);
